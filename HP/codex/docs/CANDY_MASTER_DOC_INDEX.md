...
| 23 | `HP/codex/docs/CANDY_PRODUCTION_MIGRATION_MASTER.md` | 本番スナップショット・最新HPの全件照合、シティヘブン転送維持、index.php最終公開切替、段階移行、STOP条件、ロールバック |
| 24 | `HP/codex/docs/CANDY_PRODUCTION_MIGRATION_INVENTORY.csv` | 再取得後の新旧全1,767相対パスのSHA-256、状態、移行フェーズ、危険度、確認状態 |
