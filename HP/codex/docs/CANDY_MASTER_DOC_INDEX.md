...
| blog新規生成 | `CANDY_PAGE_GENERATION_GOVERNANCE.md`、`CANDY_BLOG_PAGE_GENERATION_SPEC.md` |
| hotel新規生成 | `CANDY_PAGE_GENERATION_GOVERNANCE.md`、`CANDY_HOTEL_PAGE_GENERATION_SPEC.md` |
