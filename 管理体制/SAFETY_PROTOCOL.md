...
2. `AGENTS.md`、`README.md`、必要な管理文書を読んだ証拠を出すこと。
3. `TASK_RESERVATIONS.md` で対象を予約すること。
4. Git状態を1回だけ確認すること。
5. 対象リストを固定すること。
...
- Push前に `.git/HEAD`、`.git/config`、`.git/index`、`AGENTS.md`、`README.md`、`HP/AGENTS.md`、`HP/index.php` の存在を確認する。
...
- `HEAD` が不明
- 意図せず `master` になった
- `AGENTS.md`、`README.md`、`HP/AGENTS.md`、`HP/index.php` のどれかが消えた
