...
|---|---|---|---|---|---|---|---|---|---|
| CANDY-MGMT-REPAIR-20260814 | Specification Change / Maintenance | Repair and organize the lower management-document system | Complete / Completed | [Case parent](cases/CANDY_MANAGEMENT_SYSTEM_REPAIR.md) | `DOCUMENT_RULES.md`, `codex/WORK_ROUTING.md`, `codex/README.md` | Lower management documents and the management audit script named in the parent | Complete | Repository-wide audit passed; seven retained member references are formally routed; exact results and boundaries are recorded in the parent and `TASK_LOG.md` | None |
...
The seven member implementation references under `HP/docs/` existed before the registry adoption but were outside the original audit population. `CANDY-MGMT-REPAIR-20260814` classifies them as retained implementation references owned by `CANDY_OTHER_PAGES_MANAGEMENT.md`, not as case records, without moving, renaming, duplicating, or treating live-environment claims as verified.
