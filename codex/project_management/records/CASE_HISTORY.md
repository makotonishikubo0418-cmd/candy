...
| Defect and Response History (不具合・対応履歴) | [`DEFECT_RESPONSE_HISTORY.md`](DEFECT_RESPONSE_HISTORY.md) | 10 | Route to the defect case parent, response record, or completed task detail |
