...
|---|---|---|---|
| CANDY-JOB-LINK-VANILLA-MIGRATION-20260821 | Replace the common CANDY job-offer link with the verified Vanilla destination | Atomic case row in [`CASE_REGISTRY.md`](../CASE_REGISTRY.md) | Site-wide common-navigation URL and title replacement across the exact source population, with independent GirlsHeaven portal links, PHP, database, structured-data contents, Candy `.htaccess`, and unrelated assets excluded |
