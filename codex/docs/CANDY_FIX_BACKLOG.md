...
| INDEX-PRODUCTION | `HP/index.php` | This protected target affects final production switchover | Resolve the final-switchover target through the applicable production route selected from root `AGENTS.md` Section 5.2 with target SHA, redirects, rollback method, and HTTP checks | `AWAITING_APPROVAL` |
